...
class ManagementBoard extends Component {
    ...
    render() {
        const { currentUser, teamData, players, isLoading } = this.state;
        if(isLoading) {
                ...
                <div className="ManagementBoard mt-5">
                    <div className="container">
                        <ul className="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li className="nav-item" role="presentation">
                                <button className="nav-link" id="team-tab" data-bs-toggle="tab" data-bs-target="#team" type="button" role="tab" aria-controls="team" aria-selected="false">Team</button>
                            </li>
                            <li className="nav-item" role="presentation">
                        ...
                        <div className="tab-content pt-3" id="myTabContent">
                            <div className="tab-pane fade show active" id="evenementen" role="tabpanel" aria-labelledby="evenementen-tab">
                                <p>
                                    Op dit tabblad kunnen nieuwe evenementen worden aangemaakt of al geregistreerde evenementen worden verwijderd.
                                </p>
                                <div className="row">
                            ...
                            <div className="tab-pane fade" id="team" role="tabpanel" aria-labelledby="team-tab">
                                <p>
                                    Op dit tabblad kan je spelers aan je team toevoegen of verwijderen.
                                </p>
                                {isLoading ? <span className="spinner-border spinner-border-sm"></span> : <PlayerList players={teamData.teamMembers} />}
                            </div>
